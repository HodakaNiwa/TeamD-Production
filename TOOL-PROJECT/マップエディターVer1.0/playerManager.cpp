...
// プレイヤーを生成する処理
//=============================================================================
CPlayer *CPlayerManager::SetPlayer(D3DXVECTOR3 pos, D3DXVECTOR3 rot, int nIdx)
{
	...
	// プレイヤーを生成する
	CPlayer *pPlayer = CPlayer::Create(pos, rot, nIdx, apModelCpy, pMotionManagerCpy, m_nNumParts);
