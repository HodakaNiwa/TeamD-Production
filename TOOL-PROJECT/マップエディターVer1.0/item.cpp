...
void CItemStar::Hit(CScene *pScene)
{
	...
	if (pScene->GetObjType() == OBJTYPE_PLAYER)
	{
		...
		if (CManager::GetMode() == CManager::MODE_DEMOPLAY)
		{
			...
			pDemoplay->ItemEvent_Star(nPlayerNumber);
		}
...
void CItem1up::Hit(CScene *pScene)
{
	...
	if (pScene->GetObjType() == OBJTYPE_PLAYER)
	{
		...
		{
			CDemoplay *pDemoplay = CManager::GetDemoplay();
			pDemoplay->ItemEvent_1Up(nPlayerNumber);
		}
...
void CItemHelmet::Hit(CScene *pScene)
{
	...
	if (pScene->GetObjType() == OBJTYPE_PLAYER)
	{
		...
		{
			CDemoplay *pDemoplay = CManager::GetDemoplay();
			pDemoplay->ItemEvent_Helmet(nPlayerNumber);
		}
