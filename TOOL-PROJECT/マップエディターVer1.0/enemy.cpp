	...
	{//向きが四方を向いている場合
		...
		{//撃っていない場合
			...
			case ROT_UP:	//上を向いている場合
				CBullet::Create(D3DXVECTOR3(pos.x, pos.y, pos.z), D3DXVECTOR3(0.0f, 0.0f, 0.0f), D3DXVECTOR3(0.0f, 0.0f, 8.0f), CBullet::BULLET_TYPE_ENEMY, m_pEnemy); //弾の生成
				break;
			case ROT_DOWN:	//上を向いている場合
				CBullet::Create(D3DXVECTOR3(pos.x, pos.y, pos.z), D3DXVECTOR3(0.0f, 0.0f, 0.0f), D3DXVECTOR3(0.0f, 0.0f, -8.0f), CBullet::BULLET_TYPE_ENEMY, m_pEnemy); //弾の生成
				break;
			case ROT_RIGHT:	//上を向いている場合
				CBullet::Create(D3DXVECTOR3(pos.x, pos.y, pos.z), D3DXVECTOR3(0.0f, 0.0f, 0.0f), D3DXVECTOR3(8.0f, 0.0f, 0.0f), CBullet::BULLET_TYPE_ENEMY, m_pEnemy); //弾の生成
				break;
